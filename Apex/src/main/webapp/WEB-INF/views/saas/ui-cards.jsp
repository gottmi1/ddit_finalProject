            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            ...
                            <div class="card d-block">
                                <img class="card-img-top" src="${pageContext.request.contextPath }/resources/assets/images/small/small-1.jpg" alt="Card image cap">
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card d-block">
                                <img class="card-img-top" src="${pageContext.request.contextPath }/resources/assets/images/small/small-2.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card d-block">
                                <img class="card-img-top" src="${pageContext.request.contextPath }/resources/assets/images/small/small-3.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text">Some quick example text to build on the card title and make
                                        up the bulk of the card's content. Some quick example text to build on the card title and make up.</p>
                                    <a href="javascript: void(0);" class="btn btn-primary">Button</a>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card d-block">
                                ...
                                <img class="img-fluid" src="${pageContext.request.contextPath }/resources/assets/images/small/small-4.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text">Some quick example text to build on the card title and make
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="row g-0 align-items-center">
                                    <div class="col-md-4">
                                        <img src="${pageContext.request.contextPath }/resources/assets/images/small/small-4.jpg" class="img-fluid rounded-start" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="row g-0 align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <img src="${pageContext.request.contextPath }/resources/assets/images/small/small-1.jpg" class="img-fluid rounded-end" alt="...">
                                    </div> <!-- end col -->
                                </div> <!-- end row-->
                            </div> <!-- end card -->
                        </div> <!-- end col-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <img src="${pageContext.request.contextPath }/resources/assets/images/small/small-3.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <img src="${pageContext.request.contextPath }/resources/assets/images/small/small-4.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Card with stretched link</h5>
