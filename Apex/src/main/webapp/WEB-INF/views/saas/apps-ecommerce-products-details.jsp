                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            ...
                                            <a href="javascript: void(0);" class="text-center d-block mb-4">
                                                <img src="${pageContext.request.contextPath }/resources/assets/images/products/product-5.jpg" class="img-fluid" style="max-width: 280px;" alt="Product-img" />
                                            </a>

                                            <div class="d-lg-flex d-none justify-content-center">
                                                <a href="javascript: void(0);">
                                                    <img src="${pageContext.request.contextPath }/resources/assets/images/products/product-1.jpg" class="img-fluid img-thumbnail p-2" style="max-width: 75px;" alt="Product-img" />
                                                </a>
                                                <a href="javascript: void(0);" class="ms-2">
                                                    <img src="${pageContext.request.contextPath }/resources/assets/images/products/product-6.jpg" class="img-fluid img-thumbnail p-2" style="max-width: 75px;" alt="Product-img" />
                                                </a>
                                                <a href="javascript: void(0);" class="ms-2">
                                                    <img src="${pageContext.request.contextPath }/resources/assets/images/products/product-3.jpg" class="img-fluid img-thumbnail p-2" style="max-width: 75px;" alt="Product-img" />
                                                </a>
                                            </div>
                                        </div> <!-- end col -->
                                        <div class="col-lg-7">
