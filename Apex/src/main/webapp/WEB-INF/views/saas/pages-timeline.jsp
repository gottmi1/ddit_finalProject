                                        ...
                                        <div class="timeline-box">
                                            ...
                                            <div class="timeline-album mb-3">
                                                <a href="javascript: void(0);">
                                                    <img alt="" src="${pageContext.request.contextPath }/resources/assets/images/small/small-1.jpg">
                                                </a>
                                                <a href="javascript: void(0);">
                                                    <img alt="" src="${pageContext.request.contextPath }/resources/assets/images/small/small-2.jpg">
                                                </a>
                                                <a href="javascript: void(0);">
                                                    <img alt="" src="${pageContext.request.contextPath }/resources/assets/images/small/small-3.jpg">
                                                </a>
                                            </div>
                                ...
                                <div class="timeline-lg-item timeline-item-right">
                                    <div class="timeline-desk">
                                        <div class="timeline-box">
                                            ...
                                            <div class="d-flex">
                                                <img src="${pageContext.request.contextPath }/resources/assets/images/users/avatar-3.jpg" alt="Arya S" class="rounded-circle me-2" height="24">
                                                <div>
