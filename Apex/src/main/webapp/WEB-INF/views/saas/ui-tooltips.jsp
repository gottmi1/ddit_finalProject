...
<head>
    <meta charset="utf-8" />
    <title>Tooltips | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="default-tooltips-code">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="disabled-tooltips-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
                                                        &lt;span class=&quot;d-inline-block&quot; tabindex=&quot;0&quot; data-bs-toggle=&quot;tooltip&quot; data-bs-title=&quot;Disabled tooltip&quot;&gt;
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="four-tooltips-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
                                                        &lt;button type=&quot;button&quot; class=&quot;btn btn-info&quot; data-bs-toggle=&quot;tooltip&quot; data-bs-placement=&quot;top&quot; data-bs-title=&quot;Tooltip on top&quot;&gt;Tooltip on top&lt;/button&gt;
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="html-tooltips-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted font-14">We set a custom class with ex. <code>data-bs-custom-class="primary-tooltip"</code> to scope our background-color primary appearance and use
                                        it to override a local CSS
                                        variable.</p>

                                    <ul class="nav nav-tabs nav-bordered mb-3">
                                        <li class="nav-item">
                                            <a href="#custom-tooltips-preview" data-bs-toggle="tab" aria-expanded="false" class="nav-link active">
                                                Preview
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#custom-tooltips-code" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                                                Code
                                            </a>
                                        </li>
                                    </ul> <!-- end nav-->
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="custom-tooltips-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
