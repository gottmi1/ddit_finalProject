...
<body>
    ...
    <!-- Sparkline Chart js -->
    <script src="${pageContext.request.contextPath }/resources/assets/vendor/jquery-sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline Chart Demo js -->
    <script src="${pageContext.request.contextPath }/resources/assets/js/pages/demo.sparkline.js"></script>
