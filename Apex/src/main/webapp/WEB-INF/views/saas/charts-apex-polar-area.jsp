...
<head>
    <meta charset="utf-8" />
    <title>Apex Polar Area Charts | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Polar Area Charts</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
    ...
    <script src="${pageContext.request.contextPath }/resources/assets/js/pages/demo.apex-polar-area.js"></script>
