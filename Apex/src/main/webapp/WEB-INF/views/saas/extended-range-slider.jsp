...
<head>
    <meta charset="utf-8" />
    <title>Range Slider | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
...
<body>
    ...
    <script src="${pageContext.request.contextPath }/resources/assets/js/ui/component.range-slider.js"></script>
