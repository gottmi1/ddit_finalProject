                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane m-3 pt-0 code" id="default-scroll-code">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane m-3 pt-0 code" id="left-scroll-code">
                                        <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                        <pre class="mb-0">
                                                <span class="html escape">
                                                    &lt;!-- HTML --&gt;
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane m-3 pt-0 code" id="size-scroll-code">
                                        <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                        <pre class="mb-0">
                                                <span class="html escape">
                                                    &lt;!-- HTML --&gt;
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane m-3 pt-0 code" id="color-scroll-code">
                                        <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                        <pre class="mb-0">
                                                <span class="html escape">
                                                    &lt;!-- HTML --&gt;
