                                ...
                                <div class="card-body">
                                    ...
                                    <div class="clearfix">
                                        <div class="float-start mb-3">
                                            <img src="${pageContext.request.contextPath }/resources/assets/images/logo-dark.png" alt="dark logo" height="22">
                                        </div>
                                        <div class="float-end">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="text-sm-end">
                                                <img src="${pageContext.request.contextPath }/resources/assets/images/barcode.png" alt="barcode-image" class="img-fluid me-2" />
                                            </div>
                                        </div> <!-- end col-->
                                    </div>
                                    <!-- end row -->
