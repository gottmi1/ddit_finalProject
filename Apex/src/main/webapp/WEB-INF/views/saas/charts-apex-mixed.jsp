...
<head>
    <meta charset="utf-8" />
    <title>Apex Mixed Charts | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
...
<body>
    ...
    <script src="${pageContext.request.contextPath }/resources/assets/js/pages/demo.apex-mixed.js"></script>
