    ...
    <nav class="navbar navbar-expand-lg py-lg-3 navbar-dark">
        <div class="container">
            ...
            <a href="index.html" class="navbar-brand me-lg-5">
                <img src="${pageContext.request.contextPath }/resources/assets/images/logo.png" alt="logo" class="logo-dark" height="22" />
            </a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 offset-md-2">
                    <div class="text-md-end mt-3 mt-md-0">
                        <img src="${pageContext.request.contextPath }/resources/assets/images/svg/startup.svg" alt="" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mt-1">
                <div class="col-lg-4 col-md-6">
                    <div class="demo-box text-center mt-3">
                        <img src="${pageContext.request.contextPath }/resources/assets/images/layouts/layout-1.png" alt="demo-img" class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="demo-box text-center mt-3">
                        <img src="${pageContext.request.contextPath }/resources/assets/images/layouts/layout-2.png" alt="demo-img" class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="demo-box text-center mt-3">
                        <img src="${pageContext.request.contextPath }/resources/assets/images/layouts/layout-3.png" alt="demo-img" class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="demo-box text-center mt-3">
                        <img src="${pageContext.request.contextPath }/resources/assets/images/layouts/layout-5.png" alt="demo-img" class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="demo-box text-center mt-3">
                        <img src="${pageContext.request.contextPath }/resources/assets/images/layouts/layout-6.png" alt="demo-img" class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="demo-box text-center mt-3">
                        <img src="${pageContext.request.contextPath }/resources/assets/images/layouts/layout-4.png" alt="demo-img" class="img-fluid shadow-sm rounded">
        ...
        <div class="container">
            ...
            <div class="row mt-2 py-5 align-items-center">
                <div class="col-lg-5 col-md-6">
                    <img src="${pageContext.request.contextPath }/resources/assets/images/svg/features-1.svg" class="img-fluid" alt="">
                </div>
            ...
            <div class="row pb-3 pt-5 align-items-center">
                ...
                <div class="col-lg-5 col-md-6 offset-md-1">
                    <img src="${pageContext.request.contextPath }/resources/assets/images/svg/features-2.svg" class="img-fluid" alt="">
                </div>
            </div>
