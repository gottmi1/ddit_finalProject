...
<body>
    ...
    <!-- Moment js -->
    <script src="${pageContext.request.contextPath }/resources/assets/vendor/moment/min/moment.min.js"></script>

    <!-- Apex Chart Timeline Demo js -->
    <script src="${pageContext.request.contextPath }/resources/assets/js/pages/demo.apex-timeline.js"></script>
