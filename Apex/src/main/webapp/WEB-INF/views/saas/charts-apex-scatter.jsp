...
<head>
    <meta charset="utf-8" />
    <title>Apex Scatter Charts | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
...
<body>
    ...
    <script src="${pageContext.request.contextPath }/resources/assets/js/pages/demo.apex-scatter.js"></script>
