...
<head>
    <meta charset="utf-8" />
    <title>Spinners | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="border-spinner-code">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="colored-spinner-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="alignment-spinner-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
                                                        &lt;div class=&quot;d-flex justify-content-center&quot;&gt;
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="size-spinner-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
                                                        &lt;!-- Large --&gt;
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="growing-spinner-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="colored-growing-spinner-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="placement-spinner-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
                                                        &lt;div class=&quot;d-flex align-items-center&quot;&gt;
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane code" id="buttons-spinner-code">
                                            <button class="btn-copy-clipboard" data-clipboard-action="copy">Copy</button>
                                            <pre class="mb-0">
                                                    <span class="html escape">
                                                        &lt;!-- Border Spinner --&gt;
