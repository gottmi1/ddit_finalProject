...
<body>
    ...
    <script src="https://apexcharts.com/samples/${pageContext.request.contextPath }/resources/assets/ohlc.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/dayjs/1.8.17/dayjs.min.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/pages/demo.apex-candlestick.js"></script>
