...
<head>
    <meta charset="utf-8" />
    <title>Vector Maps | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
...
<body>
    ...
    <script src="${pageContext.request.contextPath }/resources/assets/js/maps/in-mill-en.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/maps/canada.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/maps/iraq.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/maps/russia.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/maps/spain.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/maps/us-aea-en.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/maps/us-lcc-en.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/maps/us-mill-en.js"></script>

    <!-- Vector Maps Demo js -->
    <script src="${pageContext.request.contextPath }/resources/assets/js/pages/demo.vector-maps.js"></script>
