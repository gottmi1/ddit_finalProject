...
<body>
                        ...
                        <div class="col-xxl-3">
                            <div class="row">
                                <div class="col-md-6 col-xxl-12">
                                    <div class="card bg-primary card-bg-img" style="background-image: url(${pageContext.request.contextPath }/resources/assets/images/bg-pattern.png);">
                                        <div class="card-body">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img class="rounded-circle" src="${pageContext.request.contextPath }/resources/assets/images/users/avatar-1.jpg" alt="Avtar image" width="33">
                                                            </div>
                                                            <div class="flex-grow-1 ms-2">
                                                                Adam Baldwin
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img class="rounded-circle" src="${pageContext.request.contextPath }/resources/assets/images/users/avatar-2.jpg" alt="Avtar image" width="33">
                                                            </div>
                                                            <div class="flex-grow-1 ms-2">
                                                                Peter Wallace
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img class="rounded-circle" src="${pageContext.request.contextPath }/resources/assets/images/users/avatar-3.jpg" alt="Avtar image" width="33">
                                                            </div>
                                                            <div class="flex-grow-1 ms-2">
                                                                Jacob Dunn
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img class="rounded-circle" src="${pageContext.request.contextPath }/resources/assets/images/users/avatar-4.jpg" alt="Avtar image" width="33">
                                                            </div>
                                                            <div class="flex-grow-1 ms-2">
                                                                Terry Adams
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img class="rounded-circle" src="${pageContext.request.contextPath }/resources/assets/images/users/avatar-5.jpg" alt="Avtar image" width="33">
                                                            </div>
                                                            <div class="flex-grow-1 ms-2">
                                                                Jason Stovall
                                                            </div>
    ...
    <script src="https://apexcharts.com/samples/${pageContext.request.contextPath }/resources/assets/stock-prices.js"></script>
    <script src="https://apexcharts.com/samples/${pageContext.request.contextPath }/resources/assets/series1000.js"></script>
    <script src="https://apexcharts.com/samples/${pageContext.request.contextPath }/resources/assets/github-data.js"></script>
    <script src="https://apexcharts.com/samples/${pageContext.request.contextPath }/resources/assets/irregular-data-series.js"></script>

    <!-- Wallet Dashboard js -->
    <script src="${pageContext.request.contextPath }/resources/assets/js/pages/demo.dashboard-wallet.js"></script>
