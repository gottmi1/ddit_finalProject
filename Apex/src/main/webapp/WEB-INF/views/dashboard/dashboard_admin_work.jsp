				...
				<div class="card-body">
					<div class="row">
						<div class="col-12 text-center">
							...
							<h3 class="my-2 py-1 text-warning">${completedWorkCount }</h3>
				...
				<div class="card-body">
					<div class="row">
						<div class="col-12 text-center">
							...
							<h3 class="my-2 py-1 text-secondary">${notCompletedCount }</h3>
							<h5 class="text-muted fw-normal mt-0 text-truncate"
				...
				<div class="card-body">
					<div class="row">
						<div class="col-12 text-center">
							...
							<h3 class="my-2 py-1 text-success">${overWorkCount }</h3>
				...
				<div class="card-body">
					<div class="row">
						<div class="col-12 text-center">
							...
							<h3 class="my-2 py-1 text-primary">${totalWorkCount }</h3>
							<h5 class="text-muted fw-normal mt-0 text-truncate"
