                    ...
                    <div class="card">
                        ...
                        <div class="card-header text-center bg-body">
                            <a href="/dashboard" class="d-block">
                                <img src="${pageContext.request.contextPath }/resources/assets/images/apexLogo.png" class="pt-2" style="width:100px;" alt="logo">
                            </a>
                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                ...
                                <h5 class="text-error mt-4">500</h5>
